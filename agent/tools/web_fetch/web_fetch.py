...
class WebFetch(BaseTool):
    ...
    name: str = "web_fetch"
    description: str = (
        "Deep Research Tool: Fetch the full content of a specific URL found during `web_search`. "
        "Use this tool when search snippets are insufficient to provide a detailed or precise answer. "
        "For web pages, it extracts readable text. For documents (PDF, Word, TXT, Excel, PPT), it parses the content. "
        "NOTE: Prefer this tool over raw snippets for high-stakes information like dates, lists, and technical facts. "
