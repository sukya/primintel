...
HELP_TEXT = """Usage: cow COMMAND [ARGS]...
  ...
  Primintel CLI - Manage your Primintel instance.

Commands:
  help     Show this message.
  version  Show the version.
  start    Start Primintel.
  stop     Stop Primintel.
  restart  Restart Primintel.
  update   Update Primintel and restart.
  status   Show Primintel running status.
  logs     View Primintel logs.
  skill    Manage Primintel skills.
