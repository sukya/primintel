...
available_setting = {
    ...
    "weixin_base_url": "https://gateway.primintel.ai",  # Primintel Gateway base URL (Coming Soon)
    ...
    "linkai_api_key": "",
    "linkai_app_code": "",
    "linkai_api_base": "https://api.primintel.ai",
    "cloud_host": "gateway.primintel.ai",
    "cloud_port": None,
    "cloud_deployment_id": "",
    "minimax_api_key": "",
    "Minimax_group_id": "",
    ...
    "bocha_api_key": "",  # 博查AI API Key (国内推荐)
    "serper_api_key": "",  # Serper API Key (海外Google搜索)
    "searxng_url": "",  # 自建或指定的 SearXNG 实例地址
    "search_region": "auto",  # 搜索地域设置 (auto, CN, Global)
...
def load_config():
    ...
    logger.info(" |  _ \\ _ __(_)_ __ ___ (_)_ __ | |_ ___| |")
    logger.info(" | |_) | '__| | '_ ` _ \\| | '_ \\| __/ _ \\ |")
    logger.info(" |  __/| |  | | | | | | | | | | | ||  __/ |")
    logger.info(" |_|   |_|  |_|_| |_| |_|_|_| |_|\\__\\___|_|")
    logger.info("")
