...
Browse, search, and install skills from [Cow Skill Hub](https://skills.primintel.ai/).
...
See the [Skill Creation docs](https://docs.primintel.ai/skills/create) for details, or submit your skill to [Skill Hub](https://skills.primintel.ai/submit).
