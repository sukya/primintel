---
title: 手动安装
description: 手动部署 Primintel（源码 / Docker）
---
...
<Tip>
  若遇到网络问题可使用国内仓库地址：https://gitee.com/zhayujie/Primintel
</Tip>
...
<Tip>
  全部配置项可在项目 [`config.py`](https://github.com/zhayujie/Primintel/blob/master/config.py) 文件中查看。Docker 部署时，配置项名称需转为大写环境变量格式。
</Tip>
