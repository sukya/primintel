...
description: Deploy Primintel manually (source code / Docker)
---
...
<Tip>
  For network issues, use the mirror: https://gitee.com/zhayujie/Primintel
</Tip>
...
<Tip>
  Full configuration options are in the project [`config.py`](https://github.com/zhayujie/Primintel/blob/master/config.py).
</Tip>
