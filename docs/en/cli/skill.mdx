...
Skill management commands are used to install, query, and manage Primintel skills. Use `/skill <subcommand>` in chat or `cow skill <subcommand>` in the terminal.
...
| `cowhub` | Installed from Primintel Skill Hub |
