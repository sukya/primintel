...
description: Primintel command system — Terminal CLI and chat commands
---

Primintel provides two ways to interact via commands:
...
Service:
  start     Start the Primintel service
  stop      Stop the Primintel service
  restart   Restart the Primintel service
