---
title: WeCom
description: Integrate Primintel into WeCom enterprise app
---

Integrate Primintel into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
