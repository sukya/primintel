---
title: WeChat
description: Connect Primintel to personal WeChat
---

> Connect Primintel to your personal WeChat. Simply scan a QR code to log in — no public IP required. Supports text, image, voice, file, and video messages.
