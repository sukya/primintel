---
title: DingTalk
description: Integrate Primintel into DingTalk application
---

Integrate Primintel into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
