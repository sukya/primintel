---
title: Feishu (Lark)
description: Integrate Primintel into Feishu application
---

Integrate Primintel into Feishu by creating a custom enterprise app. You need to be a Feishu enterprise user with admin privileges.
