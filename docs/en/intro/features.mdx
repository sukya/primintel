---
title: Features
description: Primintel long-term memory, task planning, skills system, CLI commands, and browser tool in detail
---
...
- **[Skill Hub](https://skills.primintel.ai/):** An open skill marketplace featuring official, community, and third-party skills. Install with one command.
...
Visit [skills.primintel.ai](https://skills.primintel.ai/) to browse all available skills, or use commands in conversation:
...
Primintel provides two command interaction methods, covering service management, skill installation, configuration, and more:
...
See [Command Overview](https://docs.primintel.ai/en/cli) for details.
