---
title: 手動インストール
description: Primintelの手動デプロイ（ソースコード / Docker）
---
...
<Tip>
  ネットワークに問題がある場合は、ミラーを使用してください: https://gitee.com/zhayujie/Primintel
</Tip>
...
<Tip>
  すべての設定オプションはプロジェクトの [`config.py`](https://github.com/zhayujie/Primintel/blob/master/config.py) に記載されています。
</Tip>
